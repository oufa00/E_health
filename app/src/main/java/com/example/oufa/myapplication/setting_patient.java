...
public class setting_patient extends AppCompatActivity {
    ...
    CheckBox pass;
    String idpatient="",result1="",password1="";
    @NotEmpty
    @Length(min = 4,max =8)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_patient);
        ...
        background_setting_pat background_setting=new background_setting_pat(this);
        background_setting.execute(idpatient);
            ...
            if(pass.isChecked()){
                ...
                if(npasswordd1.isEmpty()){
                    ...
                    if (password1.equals(opasswordd1)) {
                       ...
                       background_setting_patient background_setting_patient = new background_setting_patient(getApplicationContext());
                       background_setting_patient.execute(nomm, prenomm, agee, emaill, telephonee, adresse, npasswordd1, idpatient);
                ...
                background_setting_patient background_setting_patient = new background_setting_patient(getApplicationContext());
                background_setting_patient.execute(nomm, prenomm, agee, emaill, telephonee, adresse, password1, idpatient);
            }
        }
    }
    public class background_setting_patient extends AsyncTask<String,Void,String> {
        Context context;
        background_setting_patient(Context cntx){
            context=cntx;
        }
        @Override
        protected String doInBackground(String... params) {

            String login_url="http://192.168.43.33/setting_pat.php";
        ...
        protected void onPostExecute(String result) {
            ...
            if (result == null)
               ...
               background_setting_pat background_setting=new background_setting_pat(context);
                background_setting.execute(idpatient);
            }
        }
    ...
    public class background_setting_pat extends AsyncTask<String,Void,String> {
        Context context;


        background_setting_pat(Context cntx) {
            context = cntx;
        }
        ...
        protected String doInBackground(String... params) {
            ...
            String jsonurl = "http://192.168.43.33/get_info_pat.php";
